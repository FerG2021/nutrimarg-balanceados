                    ...
                    <tbody>
                       @foreach ($clients as $client)
                            <tr>
                                ...
                                <td>{{ $client->directionClient }}</td>
                                <td>{{ $client->phoneClient }}</td>
                                <td>{{ $client->mailClient }}</td>
                                <td>                               
                                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                        <a href="/client/{{$client->id}}/editclient" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-edit"></i></a>
                                        <a href="/client/{{$client->id}}/deleteclient" class="btn btn-danger"  data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="fas fa-trash-alt"></i></a>
                                    </div>
                                </td>
                            </tr> 
                       @endforeach
