...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/productsinstock') }}" class="nav-link"><i class="fas fa-boxes"></i> Productos en stock</a>
    </li>  
@endsection
                        ...
                        <tr>
                            ...
                            <td class="descriptionname">
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="{{ '/product'.'/'.$p->id.'/edit' }}" data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-primary">
                                            <i class="fas fa-edit descriptionname"></i>
                                    </a>
                                    <a href="{{'/product'.'/'.$p->id.'/delete' }}" data-toggle="tooltip" data-placement="top" title="Eliminar" class="delete btn btn-danger">
