...
@section('title', 'Productos por vencimiento')

@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/productsexpiration') }}" class="nav-link"><i class="fas fa-exclamation-triangle"></i> Productos por vencimiento</a>
    </li>  
@endsection
...
<div class="container-fluid">
    <div class="panel shadow">
        <div class="header">
            <h2 class="title"><i class="fas fa-exclamation-triangle"></i> Productos por vencimiento</h2>
        </div>
