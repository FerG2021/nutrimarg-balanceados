...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/movsproductsadd') }}" class="nav-link"><i class="fas fa-arrow-right"></i> Ingreso de productos</a>
    </li>  
@endsection
...
<div class="container-fluid">
    <div class="panel shadow">
        <div class="header">
            <h2 class="title"><i class="fas fa-arrow-right"></i> Ingreso de productos</h2>
        </div>

        <div class="browse mtop16">
            <label for="stockmin" class="descriptionname txt18" >¿No existe el producto?</label>            
            <a href="{{ url('/addproduct') }}" class="descriptionname txt18 btn btn-primary">Agregar nuevo producto</a>
        </div>
                    ...
                    @foreach ($products as $p)
                        <tr>
                            ...
                            <td class="descriptionname">
                                <div class="opts">
                                    <a href="{{ '/movsproductsadd'.'/'.$p->id.'/add' }}" data-toggle="tooltip" data-placement="top" title="Nueva compra" class="btn btn-success"><i class="fas fa-shopping-cart"></i>          
                                    </a>        
