...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="" class="nav-link"><i class="fas fa-info-circle"></i> Detalle de presupuesto</a>
    </li>  
@endsection
        ...
        <div class="col-md-12">
            <div class="container-fluid">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-info-circle"></i></i> Detalle de presupuesto - Presupuesto N: {{$id}}</h2>
                    </div>       
                   ...
                   <div class="inside">
                        ...
                        <div class="table mtop16 descriptionname">
                            ...
                            <a href="/budget/{{$budget->id}}/getpdf" target="_blank" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Generar PDF"><i class="far fa-file-pdf"></i> Generar PDF</a>
