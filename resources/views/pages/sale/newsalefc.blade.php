...
@section('content')
            ...
            <div class="container-fluid">
                <div class="panel shadow">
                   ...
                   {{-- AGREGAR PRODUCTO AL PRESUPUESTO --}}
                    <div class="inside">  
                        <h5 class="descriptionname">Datos nueva venta - Firma comercial</h5>
                        ...
                        <form action="{{ url('/sale/newsalefc') }}" id="formNewBudget" method="POST">
                        @csrf
                            <div class="mtop16">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row mtop16">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-user-tie"></i></span>
                                            <select name="nameBuyer" id="nameBuyer" class="form-select" onchange="selectIdClientFC();">
                                                <option selected disabled>Seleccione un cliente</option>
                                                @foreach ($clientfirms as $clientfirm)
                                                    <option value="{{$clientfirm->id}}" data-name = "{{$clientfirm->nameFirm}}">{{$clientfirm->nameFirm}}</option>
                                                @endforeach
                                            </select>
                                        </div>     
                                    </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content descriptionname">
            ...
            <h5 class="modal-title" id="staticBackdropLabel">Añadir nuevo cliente - Firma comercial</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            <form action="{{url('/sale/addnewclientfirmsale')}}" method="POST">
            @csrf
                <div class="row">
                    {{-- CUIT del cliente --}}
