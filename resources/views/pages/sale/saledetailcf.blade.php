...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/budget.newbudget') }}" class="nav-link"><i class="fas fa-plus-circle"></i> Nueva venta (Consumidor final)</a>
    </li>  
@endsection
    ...
    <div class="col-md-12">
        <div class="container-fluid">
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title"><i class="fas fa-clipboard-list"></i> Nueva venta (Consumidor final) - Venta N: {{$id}}</h2>
                </div>       
               ...
               <div class="inside">
                    ...
                    <div class="table mtop16 descriptionname">
                                ...
                                <tbody>
                                    @foreach ($saleproducts as $saleproduct)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/sale/{{$saleproduct->id}}/deletesaleproductcf" class="btn btn-danger">Quitar</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <form action="{{ url('/sale/addnewsaleconfirmcf') }}" id="formpricebudget" method="POST">
                        @csrf
                            ...
                            <div class="btn">
                                ...
                                <a href="/sale/{{$id}}/cancelnewsalecf" class="btn btn-danger">Cancelar venta</a>    
                            </div>
