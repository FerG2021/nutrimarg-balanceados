...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/budget.newbudget') }}" class="nav-link"><i class="fas fa-plus-circle"></i> Nueva venta (Persona)</a>
    </li>  
@endsection
    ...
    <div class="col-md-12">
        <div class="container-fluid">
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title"><i class="fas fa-clipboard-list"></i> Nueva venta (Persona) - Venta N: {{$id}}</h2>
                </div>       
               ...
               <div class="inside">
                    ...
                    <div class="table mtop10 descriptionname">
                        ...
                        <form action="{{ url('/sale/addnewsaleconfirmp') }}" id="formpricebudget" method="POST">
                        @csrf
                            ...
                            @foreach ($clients as $client)
                                ...
                                <input type="hidden" id="dniClient" name="dniClient" value="{{$client->dni}}">
                            ...
                            <div class="btn">
                                <button class="btn btn-success"></i> Guardar venta</button>
                        </form>
                                <a href="/sale/{{$id}}/cancelnewsalep" class="btn btn-danger">Cancelar venta</a>    
                            </div>
    ...
    <div class="modal fade" id="modalAddProduct" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/sale/{{$id}}/addnewsaleproductp" method="POST" id="modalAddProduct">
                @csrf
                    <div class="row">
